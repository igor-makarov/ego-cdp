...
import { getUserDataDir, getProxyHost } from '../common/config.js';
...
export function start(proxyPort, cdpPort) {
  ...
  console.log(`Caddy starting (${getProxyHost()}:${proxyPort} → localhost:${cdpPort}), config: ${configDisplay}`);
}
